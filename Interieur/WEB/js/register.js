const passwordInput = document.getElementById('password');
        ...
        document.getElementById('confirm_password').addEventListener('input', checkRegisterPasswordMatch);
        document.getElementById('password').addEventListener('input', checkRegisterPasswordMatch);

        function checkRegisterPasswordMatch() {
            const pwd = document.getElementById('password').value;
            const confirm = document.getElementById('confirm_password').value;
            const msg = document.getElementById('register-password-match-message');
